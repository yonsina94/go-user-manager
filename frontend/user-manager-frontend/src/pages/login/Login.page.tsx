...
const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        setError(error || new Error("There's occur a error when trying to make login"))
    } finally {
        setLoading(false)
    }
}
...
return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
        ...
        <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Ingresa tus credenciales a continuacion</p>
        </div>
